...
namespace FineArts.Controllers
{
    public class CompetitionController : Controller
    {
        ...
        {
            var competitions = await _context.compettions
                .Include(c => c.Staff)
                .ToListAsync();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var competition = await _context.compettions
                .Include(c => c.Staff)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var competition = await _context.compettions.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (competition != null)
            {
                _context.compettions.Remove(competition);
                await _context.SaveChangesAsync();
            }
        ...
        {
            return _context.compettions.Any(e => e.CompetitionId == id);
        }
    }
}